              ...
              <form  class="mb-3">
                ...
                <div class="row">
                  ...
                  <div class=" col form-group form-floating mb-3">
                      ...
                      <label for="stock">Codigo del proveedor</label>
                    ...
                    <div class=" col form-group form-floating mb-3">
                      <input type="text" id="añejamiento"   class="form-control rounded-2" placeholder="añejamiento"  v-model=" añejamiento" />
                      <label for="añejamiento">Codigo del añejamiento</label>
